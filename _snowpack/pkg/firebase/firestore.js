 ...
 */ function C$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.DEBUG) {
        var i = n.map(L$1);
        A$1.debug.apply(A$1, __spreadArray([ "Firestore (8.10.0): " + t ], i));
    }
}
...
function x$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.ERROR) {
        var i = n.map(L$1);
        A$1.error.apply(A$1, __spreadArray([ "Firestore (8.10.0): " + t ], i));
    }
}
...
function R$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.WARN) {
        var i = n.map(L$1);
        A$1.warn.apply(A$1, __spreadArray([ "Firestore (8.10.0): " + t ], i));
    }
}
 ...
 */ function Zu(t, n) {
    ...
    if (t = getModularInstance(t), Uu("collection", "path", n), t instanceof Yu) return Qu(r = H$1.fromString.apply(H$1, __spreadArray([ n ], i))), 
    ...
    return Qu(r = H$1.fromString.apply(H$1, __spreadArray([ t.path ], i)).child(H$1.fromString(n))), new Ju(t.firestore, 
    /* converter= */ null, r);
}
...
var Cc$1 = /** @class */ function() {
    ...
    return t.iu = function(e, n, r) {
        ...
        try {
            return 1 === arguments.length ? yc$1(this._delegate, t) : yc$1.apply(void 0, __spreadArray([ this._delegate, t, n ], r));
        } catch (t) {
 ...
 */
    function(e, r) {
        ...
        return new _c(e, new ua$1(e, s), new Ec$1);
