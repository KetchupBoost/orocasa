 ...
 */ function C$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.DEBUG) {
        var i = n.map(L$1);
        A$1.debug.apply(A$1, __spreadArray([ "Firestore (8.10.1): " + t ], i));
    }
}
...
function x$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.ERROR) {
        var i = n.map(L$1);
        A$1.error.apply(A$1, __spreadArray([ "Firestore (8.10.1): " + t ], i));
    }
}
...
function R$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.WARN) {
        var i = n.map(L$1);
        A$1.warn.apply(A$1, __spreadArray([ "Firestore (8.10.1): " + t ], i));
    }
}
...
/** Creates a deep copy of `source`. */ function _t(t) {
    ...
    if (t.mapValue) {
        ...
        return Q$1(t.mapValue.fields, (function(t, n) {
...
var Nt = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , K$1.min(), Et.empty(), 0 /* SYNCED */);
    }, 
    /**
...
var on$1 = new $e(ct.comparator);

function sn() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = on$1, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var xo = /** @class */ function() {
    ...
    return __extends$1(n, e), n.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            i = An(t, r.document), o = r.readTime ? En(r.readTime) : K$1.min(), u = Nt.newNoDocument(i, o), 
            ...
            return e.targetIds && e.targetIds.length ? K$1.min() : e.readTime ? En(e.readTime) : K$1.min();
        }(t);
                ...
                return e && as(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return __awaiter(this, void 0, void 0, (function() {
                        ...
                        return __generator(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return Qe(i = e.code) && i !== N$1.ABORTED ? (n = t.Fr.shift(), 
 ...
 */ function Zu(t, n) {
    ...
    if (t = getModularInstance(t), Uu("collection", "path", n), t instanceof Yu) return Gu(r = H$1.fromString.apply(H$1, __spreadArray([ n ], i))), 
    ...
    return Gu(r = H$1.fromString.apply(H$1, __spreadArray([ t.path ], i)).child(H$1.fromString(n))), new Ju(t.firestore, 
    /* converter= */ null, r);
}
 ...
 */ function ta$1(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = V$1.u()), Uu("doc", "path", n), t instanceof Yu) return Ku(r = H$1.fromString.apply(H$1, __spreadArray([ n ], i))), 
    new $u(t, 
    /* converter= */ null, new ct(r));
    if (!(t instanceof $u || t instanceof Ju)) throw new D$1(N$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Ku(r = t._path.child(H$1.fromString.apply(H$1, __spreadArray([ n ], i)))), new $u(t.firestore, t instanceof Ju ? t.converter : null, new ct(r));
}
...
function Oa$1(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : Q$1(t, (function(t, r) {
        var i = La$1(r, e.kc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
 ...
 */ var ja$1 = /** @class */ function() {
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(Ga$1("DocumentSnapshot.get", t));
 ...
 */
function Ga$1(t, e) {
    return "string" == typeof e ? qa$1(t, e) : e instanceof la ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var Qa$1 = /** @class */ function() {
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(Ga$1("DocumentSnapshot.get", t));
    ...
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new Qa$1(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Wa$1(n._firestore, n._userDataWriter, r.key, r, new Qa$1(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new Wa$1(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Qa$1(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Wa$1(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Qa$1(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
...
function sc$1(t, e, n) {
    ...
    throw new D$1(N$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Qu(n) + ".");
}
 ...
 */ var cc$1 = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return Q$1(t.fields, (function(t, i) {
...
var fc$1 = /** @class */ function(e) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = dc$1(t, this._firestore), i = hc$1(r.converter, e, n), o = _a(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = getModularInstance(e)) || e instanceof la ? xa$1(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Ca$1(this._dataReader, "WriteBatch.update", s._key, e), 
 ...
 */ function yc$1(t, e, n) {
    ...
    return gc$1(r, [ _a(Ta$1(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, De.none()) ]);
}
...
function vc$1(t, e, n) {
    ...
    return gc$1(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof la ? xa$1(s, "updateDoc", t._key, e, n, r) : Ca$1(s, "updateDoc", t._key, e)).toMutation(t._key, De.exists(!0)) ]);
}
 ...
 */ function wc$1(t, e, n) {
    ...
    return new za$1(t, i, e._key, r, new Qa$1(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var bc$1 = /** @class */ function(e) {
     ...
     */    return __extends$1(n, e), n.prototype.get = function(t) {
        ...
        return e.prototype.get.call(this, t).then((function(t) {
            return new za$1(n._firestore, i, r._key, t._document, new Qa$1(
            /* hasPendingWrites= */ !1, 
    ...
    return t.prototype.get = function(t) {
        ...
        var r = dc$1(t, this._firestore), i = hc$1(r.converter, e, n), o = _a(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = getModularInstance(e)) || e instanceof la ? xa$1(this._dataReader, "Transaction.update", s._key, e, n, r) : Ca$1(this._dataReader, "Transaction.update", s._key, e), 
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function Ic$1() {
    if ("undefined" == typeof Uint8Array) throw new D$1(N$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function Tc$1() {
...
/** Immutable class holding a blob (binary data) */ var _c = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        return Tc$1(), new t(da$1.fromBase64String(e));
    }, t.fromUint8Array = function(e) {
        return Ic$1(), new t(da$1.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return Tc$1(), this._delegate.toBase64();
    }, t.prototype.toUint8Array = function() {
        return Ic$1(), this._delegate.toUint8Array();
    }, t.prototype.isEqual = function(t) {
 ...
 */;
        ...
        try {
            return new Uc$1(this, Zu(this._delegate, t));
        } catch (t) {
            throw Rc$1(t, "collection()", "Firestore.collection()");
        }
    }, t.prototype.doc = function(t) {
        try {
            return new xc$1(this, ta$1(this._delegate, t));
        } catch (t) {
            throw Rc$1(t, "doc()", "Firestore.doc()");
        }
    }, t.prototype.collectionGroup = function(t) {
        try {
            return new Mc$1(this, function(t, e) {
 ...
 */
            ...
            throw Rc$1(t, "collectionGroup()", "Firestore.collectionGroup()");
        }
        ...
        return function(t, e) {
            ...
            return t(new Ac$1(e, n));
        }));
    }, t.prototype.batch = function() {
        var t = this;
        return aa$1(this._delegate), new kc$1(new lc$1(this._delegate, (function(e) {
            return gc$1(t._delegate, e);
        })));
...
}(), Nc$1 = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).firestore = t, n;
    }
    return __extends$1(n, e), n.prototype.convertBytes = function(t) {
        return new _c(new da$1(t));
    }, n.prototype.convertReference = function(t) {
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return xc$1.eu(e, this.firestore, /* converter= */ null);
    }, n;
}(cc$1);
...
/**
 * A reference to a transaction.
 */ var Ac$1 = /** @class */ function() {
    function t(t, e) {
        this._firestore = t, this._delegate = e, this._userDataWriter = new Nc$1(t);
    }
    return t.prototype.get = function(t) {
        var e = this, n = Bc$1(t);
        return this._delegate.get(n).then((function(t) {
            return new Pc$1(e._firestore, new za$1(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n.converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Bc$1(t);
    ...
    return t.prototype.fromFirestore = function(t, e) {
        ...
        /* converter= */ null);
        return this._delegate.fromFirestore(new Fc$1(this._firestore, n), null != e ? e : {});
    ...
    t.nu = function(e, n) {
        ...
        var o = i.get(n);
        return o || (o = new t(e, new Nc$1(e), n), i.set(n, o)), o;
    }, t;
}();
 ...
 */
var xc$1 = /** @class */ function() {
    function t(t, e) {
        this.firestore = t, this._delegate = e, this._userDataWriter = new Nc$1(t);
    }
    return t.iu = function(e, n, r) {
        ...
        get: function() {
            return new Uc$1(this.firestore, this._delegate.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "path", {
        ...
        try {
            return new Uc$1(this.firestore, Zu(this._delegate, t));
        } catch (t) {
            throw Rc$1(t, "collection()", "DocumentReference.collection()");
        }
    }, t.prototype.isEqual = function(t) {
        ...
        try {
            return e ? yc$1(this._delegate, t, e) : yc$1(this._delegate, t);
        } catch (t) {
            throw Rc$1(t, "setDoc()", "DocumentReference.set()");
        }
    }, t.prototype.update = function(t, n) {
        for (var r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        try {
            return 1 === arguments.length ? vc$1(this._delegate, t) : vc$1.apply(void 0, __spreadArray([ this._delegate, t, n ], r));
        } catch (t) {
            throw Rc$1(t, "updateDoc()", "DocumentReference.update()");
        }
    }, t.prototype.delete = function() {
        return gc$1(zu((t = this._delegate).firestore, ua$1), [ new je(t._key, De.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = Lc$1(e), i = Oc$1(e, (function(e) {
            return new Pc$1(t.firestore, new za$1(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
        return mc$1(this._delegate, r, i);
    }, t.prototype.get = function(t) {
        var e = this;
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return function(t, e) {
                ...
                return new za$1(e, o, t._key, n, new Qa$1(null !== n && n.hasLocalMutations, 
            ...
            return new Pc$1(e.firestore, new za$1(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Cc$1.nu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Pc$1 = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        try {
            ...
            return new t(this.firestore, Za$1(this._delegate, function(t, e, n) {
                var r = e, i = Ga$1("where", t);
                return new tc$1(i, r, n);
            }(e, n, r)));
        } catch (e) {
            throw Rc$1(e, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            ...
            throw Rc$1(e, "limit()", "Query.limit()");
        }
        ...
        try {
            ...
            throw Rc$1(e, "limitToLast()", "Query.limitToLast()");
        }
        ...
        try {
            ...
            throw Rc$1(e, "startAt()", "Query.startAt()");
        }
        ...
        try {
            ...
            throw Rc$1(e, "startAfter()", "Query.startAfter()");
        }
        ...
        try {
            ...
            throw Rc$1(e, "endBefore()", "Query.endBefore()");
        }
        ...
        try {
            ...
            throw Rc$1(e, "endAt()", "Query.endAt()");
        }
    }, t.prototype.isEqual = function(t) {
     ...
     */
        function(t) {
            ...
            return new qc$1(e.firestore, new Ha$1(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Lc$1(e), i = Oc$1(e, (function(e) {
            return new qc$1(t.firestore, new Ha$1(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return mc$1(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Cc$1.nu(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return Object.defineProperty(t.prototype, "type", {
        ...
        get: function() {
            return new Fc$1(this._firestore, this._delegate.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Mc$1(this._firestore, this._delegate.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "metadata", {
        ...
        get: function() {
            ...
            return this._delegate.docs.map((function(e) {
                return new Fc$1(t._firestore, e);
            }));
        },
        enumerable: !1,
        configurable: !0
        ...
        return this._delegate.docChanges(t).map((function(t) {
            return new Vc$1(e._firestore, t);
        }));
    }, t.prototype.forEach = function(t, e) {
        var n = this;
        this._delegate.forEach((function(r) {
            t.call(e, new Fc$1(n._firestore, r));
        }));
    }, t.prototype.isEqual = function(t) {
        return $a$1(this._delegate, t._delegate);
    }, t;
}(), Uc$1 = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
    ...
    return __extends$1(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t ? new xc$1(this.firestore, t) : null;
        },
        enumerable: !1,
        configurable: !0
    }), n.prototype.doc = function(t) {
        try {
            return new xc$1(this.firestore, void 0 === t ? ta$1(this._delegate) : ta$1(this._delegate, t));
        } catch (t) {
            throw Rc$1(t, "doc()", "CollectionReference.doc()");
        }
    }, n.prototype.add = function(t) {
        var e = this;
        return function(t, e) {
            var n = zu(t.firestore, ua$1), r = ta$1(t), i = hc$1(t.converter, e);
            return gc$1(n, [ _a(Ta$1(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, De.exists(!1)) ]).then((function() {
                return r;
            }));
        }(this._delegate, t).then((function(t) {
            return new xc$1(e.firestore, t);
        }));
    }, n.prototype.isEqual = function(t) {
        return ea$1(this._delegate, t._delegate);
    }, n.prototype.withConverter = function(t) {
        return new n(this.firestore, t ? this._delegate.withConverter(Cc$1.nu(this.firestore, t)) : this._delegate.withConverter(null));
    }, n;
}(Mc$1);
...
var C$2 = {
    ...
    Transaction: Ac$1,
    WriteBatch: kc$1,
    DocumentReference: xc$1,
    DocumentSnapshot: Pc$1,
    Query: Mc$1,
    QueryDocumentSnapshot: Fc$1,
    QuerySnapshot: qc$1,
 ...
 */
    function(e, r) {
        ...
        return new Sc$1(e, new ua$1(e, s), new Ec$1);
