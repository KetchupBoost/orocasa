...
// (319:14) {#each categories as category, i (i)}
...
// (314:12) <Collection                path={'categories'}                query={ref => ref.orderBy('title', 'asc')}                let:data={categories}              >
