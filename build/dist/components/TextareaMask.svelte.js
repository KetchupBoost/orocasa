/* src\components\TextareaMask.svelte generated by Svelte v3.46.3 */
import {
	SvelteComponent,
	action_destroyer,
	assign,
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let textarea_levels = [/*attrs*/ ctx[2]];
	let textarea_data = {};
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					action_destroyer(action_action = /*action*/ ctx[3].call(null, textarea, /*maskRef*/ ctx[0])),
					listen(textarea, "accept", /*accept*/ ctx[4]),
					listen(textarea, "accept", /*accept_handler*/ ctx[6]),
					listen(textarea, "complete", /*complete_handler*/ ctx[7])
				];
		...
		p(ctx, [dirty]) {
			set_attributes(textarea, textarea_data = get_spread_update(textarea_levels, [dirty & /*attrs*/ 4 && /*attrs*/ ctx[2]]));
...
class TextareaMask extends SvelteComponent {
	constructor(options) {
		super();
