...
/* src\components\Multiselect.svelte generated by Svelte v3.43.1 */
import {
	SvelteComponent,
	append,
	attr,
...
function create_else_block(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (show_if == null || dirty & /*selected, items*/ 5) show_if = !!(/*selected*/ ctx[0].length < Object.keys(/*items*/ ctx[2]).length);
