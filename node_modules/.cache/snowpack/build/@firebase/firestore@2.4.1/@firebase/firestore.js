...
import { getUA, isSafari, isMobileCordova, isReactNative, isElectron, isIE, isUWP, isBrowserExtension, getModularInstance, createMockUserToken } from '@firebase/util';
 ...
 */ function C(t) {
    ...
    if (A.logLevel <= LogLevel.DEBUG) {
        var i = n.map(L);
        A.debug.apply(A, __spreadArray([ "Firestore (8.10.1): " + t ], i));
    }
}
...
function x(t) {
    ...
    if (A.logLevel <= LogLevel.ERROR) {
        var i = n.map(L);
        A.error.apply(A, __spreadArray([ "Firestore (8.10.1): " + t ], i));
    }
}
...
function R(t) {
    ...
    if (A.logLevel <= LogLevel.WARN) {
        var i = n.map(L);
        A.warn.apply(A, __spreadArray([ "Firestore (8.10.1): " + t ], i));
    }
}
 ...
 */ var W = /** @class */ function() {
    ...
    return __extends(n, e), n.prototype.construct = function(t, e, r) {
        return new n(t, e, r);
 ...
 */ var Ii = /** @class */ function() {
    ...
    return __extends(n, e), n.prototype.applyChanges = function(t) {
...
var vo = /** @class */ function() {
     ...
     * HTTP).
     */
    return __extends(n, e), n.prototype.Fi = function(t, e, n, r) {
 ...
 */ var xo = /** @class */ function() {
    ...
    return __extends(n, e), n.prototype.wr = function(t) {
 ...
 */ function Zu(t, n) {
    ...
    if (t = getModularInstance(t), Uu("collection", "path", n), t instanceof Yu) return Gu(r = H.fromString.apply(H, __spreadArray([ n ], i))), 
    ...
    return Gu(r = H.fromString.apply(H, __spreadArray([ t.path ], i)).child(H.fromString(n))), new Ju(t.firestore, 
    /* converter= */ null, r);
}
...
var Ea = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype._toFieldTransform = function(t) {
...
var tc = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype._apply = function(t) {
...
var fc = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.convertBytes = function(t) {
        return new da(t);
...
var xc = /** @class */ function() {
    ...
    return t.iu = function(e, n, r) {
        ...
        try {
            return 1 === arguments.length ? vc(this._delegate, t) : vc.apply(void 0, __spreadArray([ this._delegate, t, n ], r));
        } catch (t) {
...
var C$1 = {
    ...
    DocumentSnapshot: Pc,
    Query: Mc,
    QueryDocumentSnapshot: Fc,
    QuerySnapshot: qc,
    CollectionReference: Uc,
    FieldPath: jc,
    FieldValue: Kc,
    setLogLevel: Dc,
 ...
 */
    function(e, r) {
        ...
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, C$1)));
    }(e, (function(e, s) {
        return new Sc(e, new ua(e, s), new Ec);
