...
import { create_ssr_component, validate_component, missing_component, validate_store, subscribe as subscribe$1, add_attribute, escape } from 'svelte/internal';
...
const Route = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `${validate_component(currentRoute.layout || missing_component, "svelte:component").$$render(
			$$result,
			{
	...
	: `${currentRoute.component
		? `${validate_component(currentRoute.component || missing_component, "svelte:component").$$render(
				$$result,
				{
		...
		: `${currentRoute.childRoute
			? `${validate_component(Route, "svelte:self").$$render(
					$$result,
					{
						currentRoute: currentRoute.childRoute,
						params
					},
					{},
					{}
...
const Router = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	$$unsubscribe_activeRoute = subscribe$1(activeRoute, value => $activeRoute = value);
	let { routes = [] } = $$props;
	let { options = {} } = $$props;
	...
	return `${validate_component(Route, "Route").$$render($$result, { currentRoute: $activeRoute }, {}, {})}`;
});

/* node_modules\svelte-router-spa\src\components\navigate.svelte generated by Svelte v3.46.3 */

const Navigate = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let { to = '/' } = $$props;
	let { title = '' } = $$props;
	let { styles = '' } = $$props;
	let { lang = null } = $$props;
	...
	return `<a${add_attribute("href", to, 0)}${add_attribute("title", title, 0)} class="${[escape(styles), routeIsActive(to) ? "active" : ""].join(' ').trim()}">${slots.default ? slots.default({}) : ``}</a>`;
});
